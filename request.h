...
#define REQ_PROTOCOL_MC	1 /*1 means use memcache protocol*/
...
struct ohc_request_s {
	...
	string_t	ohc_key;
    string_t    mc_flag;
#define OHC_PUT_HEADERS_MAX 10 /* at most #(http_request_header_put) */
	string_t        put_headers[OHC_PUT_HEADERS_MAX];
	int		put_header_nr;
